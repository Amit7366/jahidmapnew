...
const io = new Server(server, {
    cors: {
        origin: ['http://localhost:5173', 'https://jahidmapnew.web.app', 'https://mylivlocationz.com','https://mylivlocationsz.web.app','https://maplocationlive.site', 'http://localhost:3000'],
        methods: ['GET', 'POST'],
